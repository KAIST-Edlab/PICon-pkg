...
Examples:
  ...
  python main.py --agent_model gpt-5 --agent_persona persona.txt --agent_name John
...
if __name__ == "__main__":
    ...
    result = run_interview(
        ...
        questioner_port=args.questioner_port,
        extractor_port=args.extractor_port,
        web_search_port=args.web_search_port,
        evaluator_port=args.evaluator_port,
        nhd_port=args.nhd_port,
        questioner_prompt_path=args.questioner_prompt_path,
        entity_extractor_prompt_path=args.entity_extractor_prompt_path,
        web_search_prompt_path=args.web_search_prompt_path,
